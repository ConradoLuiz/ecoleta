...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interesse sobre a coleta dos itens recicláveis`);
    }

    function handleComposeMail() {
        MailComposer.composeAsync({
            subject: 'Interesse coleta',
    ...
    return (
        <SafeAreaView style={{ flex: 1}}>
            <View style={styles.container}>
                ...
                {/* MELHORAR --->> COLOCAR A IMAGEM DE CADA ITEM */}
